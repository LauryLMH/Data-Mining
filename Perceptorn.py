...
def process(userChoice):
    ...
    featspace = get_feat_space("/Users/liuminghao/Desktop/Dataminding/data/train.positive")
    featspace = featspace.union(get_feat_space("/Users/liuminghao/Desktop/Dataminding/data/train.negative"))
    featspace = featspace.union(get_feat_space("/Users/liuminghao/Desktop/Dataminding/data/test.positive"))
    featspace = featspace.union(get_feat_space("/Users/liuminghao/Desktop/Dataminding/data/test.negative"))
    D = len(featspace)
